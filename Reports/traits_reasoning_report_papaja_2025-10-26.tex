...
Next we examined whether immigrant status was related to differences in scientific reasoning. Results from a Welch's independent samples \emph{t}-test indicated no significant differences between the two groups, \emph{t}(86.24) = -1.35, \emph{p} = .182. See Table 2 for means and standard deviations by group.

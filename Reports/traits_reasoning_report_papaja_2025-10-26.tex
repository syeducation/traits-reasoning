...
We used R (Version 4.5.2; R Core Team, 2024) and the R-packages \emph{apaTables} (Stanley, 2021), \emph{dplyr} (Version 1.1.4; Wickham, François, Henry, Müller, \& Vaughan, 2023), \emph{ggplot2} (Version 4.0.0; Wickham, 2016), \emph{groundhog} (Version 3.2.3; Simonsohn \& Gruson, 2025), \emph{knitr} (Version 1.50; Xie, 2015), \emph{labelled} (Version 2.16.0; Larmarange, 2025), \emph{papaja} (Version 0.1.4; Aust \& Barth, 2025), \emph{psych} (Version 2.5.6; William Revelle, 2025), and \emph{tinylabels} (Version 0.2.5; Barth, 2025) for all our analyses.
